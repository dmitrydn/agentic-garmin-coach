...
taper_days:
  ...
  "2026-08-26": {type: easy, duration_min: 45, zones: ["Z1","Z2"], terrain: "flat", description: "Лёгкий + strides (замена 4×3 Z3 — для тейпера ускорения уместнее качества): 15 мин разминка → 6-8×20с strides (плавный разгон до ~5k/mile усилия, НЕ спринт, восстановление трусцой 60-90с) → CD, ПЛОСКО D+≤20м. Нейромышечная свежесть без усталости. Ахилл-гейт; ниггл на первом ускорении → стоп, докатать легко."}
  "2026-08-27": {type: strength, duration_min: 55, zones: [], terrain: "gym", description: "Силовая (перенесена с 26.08, единственная в неделю): HSR подъём на носки 4×6-8 тяжело-медленно (ровный пол, БЕЗ провала пятки/step-down), RDL 3×8, hip thrust 3×10, кор."}
  "2026-08-28": {type: easy, duration_min: 35, zones: ["Z1"], terrain: "flat", description: "Лёгкий буфер перед субботней трассой: 30-35 мин Z1 ПЛОСКО, D+≤15м. Свежесть + чистый гейт под race-sim. Хуже утро → отдых."}
  ...
  "2026-09-02": {type: easy, duration_min: 50, zones: ["Z2"], terrain: "flat", description: "Силовая перенесена на пт 04.09 (сегодня без зала). Лёгкий с касанием гоночного темпа: 50 мин Z2 плоско, внутри 10 мин на ГОНОЧНОМ усилии (контроль, не жёстко), D+≤30м."}
  "2026-09-03": {type: easy, duration_min: 45, zones: ["Z2"], terrain: "flat", description: "45 мин Z2 плоско + 6×20с strides, D+≤30м."}
  "2026-09-04": {type: strength, duration_min: 45, zones: [], terrain: "gym", description: "Силовая HSR (перенесена со среды 02.09, ПОСЛЕДНЯЯ силовая цикла): HSR облегчённо 3×8, RDL, hip thrust, кор. Пятка не ниже нейтрали. Дальше тендон тоже тейперит до старта."}
