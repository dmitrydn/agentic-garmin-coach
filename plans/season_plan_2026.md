...
taper_days:
  ...
  "2026-08-26": {type: quality, duration_min: 50, zones: ["Z2","Z3"], terrain: "flat", description: "Работа (перенесена с 27.08): 15 WU → 4×3 мин Z3 (2 мин Z1 между) → CD, ПЛОСКО, D+≤30м. Единственное качество блока. Первой под нож если утро ахилла шумит."}
